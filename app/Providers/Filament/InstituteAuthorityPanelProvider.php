...
class InstituteAuthorityPanelProvider extends PanelProvider
{
    public function panel(Panel $panel): Panel
    {
        return $panel
            ->id('institute-authority')
            ->path('authority')
            ->login()
            ->colors([
            ...
            ->discoverWidgets(in: app_path('Filament/Authority/Widgets'), for: 'App\Filament\Authority\Widgets')
            ->widgets([
                AccountWidget::class,
            ])
            ->middleware([
